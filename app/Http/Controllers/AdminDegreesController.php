	...
	class AdminDegreesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		public function getDetails($id) {
			...
			$data['page_title'] = "Degree Details";
			// الرجوع إلى العرض وإرسال البيانات لعرضها
			return view('degree.details',$data);
		}
		...
		public function saveDetails(Request $request) {
			...
			CRUDBooster::redirect(CRUDBooster::adminPath('degrees/details/'.$request->certificates_id),'success','success');
