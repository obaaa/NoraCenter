<?php namespace App\Http\Controllers;
	...
	class AdminFinishedAttendancesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Lectures Number","name"=>"lectures_number","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Finished Lectures","name"=>"finished_lectures","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			$query->where('attendances.status','finished');
