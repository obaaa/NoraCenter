...
<link href="https://fonts.googleapis.com/css?family=Libre+Barcode+39+Extended" rel="stylesheet">
  ...
  <style>
    body   { font-family: 'Markazi Text', serif; text-align: center; margin: 5mm}
    ...
    /* section { border: 5px double black; } */
  </style>
</head>
...
<body class="A4 landscape">
  ...
  <section class="sheet padding-10mm container">
        <div class="row align-items-start" style="text-align: center; float:center;">
          <div class="col">
            ...
            <p>
              ...
              @endphp
              {{ $trainee_id }}
              {{-- <p style="border: 4px double black;"><span style="font-size: 20pt; font-family: 'Libre Barcode 39 Extended', cursive;">{{ $id }}</span></p> --}}
            </p>
          </div>
          <div class="col-7">
            ...
            <p style="font-size: 20pt; line-height: 13mm;font-family: 'Diplomata SC', cursive; text-align: center;">CERTIFICATE</p>
          </div>
          <div class="col" style="text-align: center; float:center;">
            ...
            <p>رقم التسجيل<br>1625</p>
          </div>
        </div>
        <hr>
        <div class="row text-align-left" style="font-size: 18pt; line-height: 10mm;font-family: 'Titillium Web', sans-serif; text-align: left;">
          <div class="col">
            <div>
    ...
    <div class="col">
    <code><p>للتأكد من صحة الشهادة <br></code>
